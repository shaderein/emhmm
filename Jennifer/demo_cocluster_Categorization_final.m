...
switch(OPT.datasource)  
  ...
  case 11
    ...
    %Explanation
    OPT.fixationfile = 'Input-Data/Explanation/all-exp-data.xlsx';
    OPT.imgdir       = 'HUAWEI-categorization-data/';
    OPT.imgsize      = [400; 520];
    OPT.imginfo      = 'HUAWEI-categorization-data/stimuli-info.xlsx';
    OPT.outdir       = 'Explanation-all-final-results/';
...
OPT.SAVE_FIXATION_PLOTS = 1;  % change this to 1 if you want to show fixations on each image.
